...
const Navbar = () => {
      ...
      return (
            <nav className='sticky top-3 flex justify-between items-center w-full py-6 px-12 bg-white/30 backdrop-blur-md rounded-2xl z-20'>
                  <div>
                  ...
                  <div className='relative hover:scale-105 transition-all duration-300'>
                        <input type='text' placeholder='Search Blog...' onChange={(e) => setInput(e.target.value)} className='py-2 px-6 w-sm font-semibold bg-white rounded-md' />
                  ...
                  <div>
                        {isLoggedIn
                              ...
                              :
                              <>
                                    <Link to={'/register'} className='py-2 px-6 font-semibold text-black bg-white border-2 border-white hover:border-2 hover:text-white hover:bg-black hover:border-black rounded-md mr-4 transition-all duration-200'>Sign Up</Link>
