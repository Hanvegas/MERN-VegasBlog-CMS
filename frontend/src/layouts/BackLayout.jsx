...
const BackLayout = () => {
      return (
            <div className=''>
                  <header className='absolute inset-0 w-full h-10 max-w-screen-2xl mx-auto mt-9 z-10'>
                        <Link to={'/blog'} className='hover:scale-95 bg-red-200'>
                              ...
                              <p className='text-xl font-semibold ml-2 mt-1'>Home</p>
                        </Link>
                  </header>
